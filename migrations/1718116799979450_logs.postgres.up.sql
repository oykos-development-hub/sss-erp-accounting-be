...
CREATE TRIGGER order_lists_insert
AFTER INSERT ON order_lists
FOR EACH ROW
EXECUTE FUNCTION log_changes();

CREATE TRIGGER order_lists_update
AFTER UPDATE ON order_lists
FOR EACH ROW
EXECUTE FUNCTION log_changes();

CREATE TRIGGER order_lists_delete
AFTER DELETE ON order_lists
FOR EACH ROW
EXECUTE FUNCTION log_changes();

CREATE TRIGGER movements_insert
AFTER INSERT ON movements
FOR EACH ROW
EXECUTE FUNCTION log_changes();

CREATE TRIGGER movements_update
AFTER UPDATE ON movements
FOR EACH ROW
EXECUTE FUNCTION log_changes();

CREATE TRIGGER movements_delete
